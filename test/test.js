...
describe("Testing for byte func", function() {
    describe("Basic testing", function() {
        // Kilo
        it(" should be 1024 for 1KiB in bytes", () => equal(byte `1KB`, BigInt(1024)));
        ...
        //Titian
        it(" should be 2^40 for 1TiB in bytes", () => equal(byte `1TB`, BigInt(1) << 40));
        it(" should be 2^37 for 1Tib in bytes", () => equal(byte `1Tib`, BigInt(1) << 37));
        ...
        it(" should be 2^40 for 1tiB in bytes", () => equal(byte `1tB`, BigInt(1) << 40));
        it(" should be 2^37 for 1tib in bytes", () => equal(byte `1tib`, BigInt(1) << 37));
        it(" should be 10^12 for 1tB in bytes", () => equal(byte `1tB`, BigInt(1000)));
        it(" should be 125 * 10^9 for 1tb in bytes", () => equal(byte `1tb`, BigInt(125)));


        //Million
        it(" should be 2^20 for 1MiB in bytes", () => equal(byte `1MB`, BigInt(1) << 20));
        it(" should be 2^17 for 1Mib in bytes", () => equal(byte `1Mib`, BigInt(1) << 17));
        ...
        //Giga
        it(" should be 2^30 for 1GiB in bytes", () => equal(byte `1GB`, BigInt(1) << 30));
        it(" should be 2^27 for 1Gib in bytes", () => equal(byte `1Gib`, BigInt(1) << 27));
...
describe("Testing for bit func", function() {
    describe("Basic testing", function() {
        // Kilo
        it(" should be 8192 for 1KiB in bits", () => equal(bit `1KB`, BigInt(8192)));
        ...
        //Titian
        it(" should be 2^43 for 1TiB in bits", () => equal(bit `1TB`, BigInt(1) << 43));
        it(" should be 2^40 for 1Tib in bits", () => equal(bit `1Tib`, BigInt(1) << 40));
        ...
        //Million
        it(" should be 2^23 for 1MiB in bits", () => equal(bit `1MB`, BigInt(1 << 20)));
        it(" should be 2^20 for 1Mib in bits", () => equal(bit `1Mib`, BigInt(1 << 17)));
        ...
        it(" should be 2^23 for 1miB in bits", () => equal(bit `1mB`, BigInt(1 << 23)));
        it(" should be 2^20 for 1mib in bits", () => equal(bit `1mib`, BigInt(1 << 20)));
        it(" should be 8000000 for 1mB in bits", () => equal(bit `1mB`, BigInt(8000000)));
        it(" should be 1000000 for 1mb in bits", () => equal(bit `1mb`, BigInt(1000000)));


        //Giga
        it(" should be 2^33 for 1GiB in bits", () => equal(bit `1GB`, BigInt(1 << 33)));
        it(" should be 2^30 for 1Gib in bits", () => equal(bit `1Gib`, BigInt(1 << 30)));
